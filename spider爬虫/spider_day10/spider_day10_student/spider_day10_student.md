...
```python
scrapy crawl maoyan -o maoyan.csv   重点
...
ITEM_PIPELINES = {}
# 10、添加下载器中间件
DOWNLOADER_MIDDLEWARES = {}  wares部件
```
...
111111111111111111111111111111111111111111111111111111
 分布式爬虫
 1.部署十台八台,部署-->分布式爬虫的系统-->带宽(网速) 调度器
原理:多台主机共享1个爬取队列
1.重写scrapy的调度器(scrapy_redis)
2.  #scrapy_redis模块  
3.sudo pip3 install scrapy_redis
为什么使用redis数据库
1.redis基于内存存储,速度快
