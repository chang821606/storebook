...
user001和user002的共同关注为:
	SINTERSTORE user001-002:inter user001 user002
	结果为: {'peiqi','qiaozhi'}
```
...
```python
user:1  --> peiqi qiaozhi danni 
user:2  --> peiqi qiaozhi lingyang
问题:
1、求 user:1 和 user:2 的共同关注 {'peiqi','qiaozhi'}
2、求 共同关注 的人数
```
